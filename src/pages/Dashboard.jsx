          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 sm:p-5 shadow-sm space-y-3 sm:space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="font-bold text-xs sm:text-sm text-slate-900 dark:text-white">Kegiatan Sedang Berlangsung / Aktif</h3>
              </div>
              <span className="px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300 font-extrabold text-[10px] sm:text-[11px]">
            ...
            <div className="space-y-1.5 pt-1 sm:pt-2">
              <div className="flex justify-between text-xs font-semibold">
                <span className="text-slate-600 dark:text-slate-400">Progres Presensi:</span>
                <span className="text-emerald-600 dark:text-emerald-400 font-mono">
                  {activeLogs.length} dari {members.length} ({Math.round((activeLogs.length / (members.length || 1)) * 100)}%)
                </span>
              </div>
            ...
            <div className="pt-2 flex justify-end">
              <button
                onClick={() => onNavigate('webcam_scan')}
                className="w-full sm:w-auto px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-2 shadow"
              >
                <Camera className="w-4 h-4" />
